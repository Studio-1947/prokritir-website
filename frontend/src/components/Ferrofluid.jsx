...
const Ferrofluid = ({
  ...
  // Cap on how many times per second the canvas is redrawn. 0 keeps the
  // published behaviour (every animation frame). Anything above it matters
  // here because each redraw invalidates the backdrop of every glass panel
  // on screen, forcing their filters to re-run.
  fps = 0
}) => {
