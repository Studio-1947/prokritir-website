          ...
          >
            ...
            <GlassPanel radius={32} backgroundOpacity={0.62} saturation={1.2}>
              <div className="relative flex max-h-screen flex-col overflow-hidden md:max-h-[92vh] md:flex-row">
                ...
                <div data-lenis-prevent className="relative z-10 flex-1 overflow-y-auto p-6 md:p-10">
                            ...
                            {items.map((p) => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`flex flex-wrap items-center gap-x-3 gap-y-3 rounded-[20px] border p-3 transition-colors duration-300 sm:flex-nowrap sm:gap-x-4 sm:p-4 ${qty > 0
