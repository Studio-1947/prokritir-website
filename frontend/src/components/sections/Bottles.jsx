              ...
              >
                <div className={`relative flex h-full flex-col p-5 sm:p-7 md:p-9 ${t.featured ? "lg:pb-12" : ""}`}>
                  ...
                  <div className="relative mx-auto flex h-[150px] w-full items-center justify-center sm:h-[230px] md:h-[270px]">
                    ...
                    <div
                      className={`aurora absolute inset-x-4 inset-y-0 ${t.featured ? "opacity-80" : "opacity-40"
                        }`}
                      aria-hidden
                    />
                    ...
                    <div
                      className={`product-shot__contact ${t.sku === "PJ-500-1" ? "product-shot__contact--narrow" : ""
                        }`}
                      aria-hidden
                    />
                    <img
                      ...
                      className={`product-shot__img relative max-h-full max-w-full select-none object-contain ${t.sku === "PJ-500-1" ? "h-full w-auto" : "w-full"
                        }`}
                    />
                  </div>
                  ...
                  <button
                    type="button"
                    onClick={() => open(t.sku)}
                    className={`mt-auto w-full py-3 text-[11px] uppercase tracking-[0.14em] sm:py-4 sm:text-[12px] sm:tracking-[0.18em] ${t.featured ? "btn-accent" : "btn-glass"
                      }`}
